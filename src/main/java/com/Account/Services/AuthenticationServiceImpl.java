...
public class AuthenticationServiceImpl implements AuthenticationService {
	...
	@Override
	public JwtAuthenticationResponse signinWithGoogle(String idToken) {
		try {
			...
			// FIXED: No reassignment, directly assign default value
			...
			User user = userRepository.findByEmail(email).orElseGet(() -> {
				...
				newUser.setFirstName(firstName); // Works perfectly now!
